...
# def math(op, x): # op - функция, в которую я передаю аргумент и она считает.
#     print(op(x))
# math(calc2, 10) # 100
# math(calc1, 10) # 20
# ---------------------------------------------------------------------------------------------------
...
# # calc(mult, 4, 5) # 20 (50 - 51, 56 - 60)
# # calc(f, 4, 5) # 9 (50 - 53, 55 - 60)
# # calc(sum, 4, 5) # 9 (50 - 60)
# calc(lambda x, y: x+y, 4, 5) # 9 (50 - 52, 56 - 60)
# -------------------------------------------------------------------------------------------------
...
# # Считываю все строчки и искуственно добавляю пробел, для логики, которая ниже описана.
...
#     # первого пробеза и превратить это в число, и добавить в список номеров(numbers).
...
# --------------------------------------------------------------------------------------------------
# data = list(map(int,input().split())) # Пишу input() - входную строку. Далее склею строки по пробелу.
...
# data = map(int,input().split()) # Строка распарсится на элементы и превратится в числа.
